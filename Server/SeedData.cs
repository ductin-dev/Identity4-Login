    ...
    public class SeedData
    {
        ...
        private static void EnsureUsers(IServiceScope scope)
        {
            ...
            if (angella == null)
            {
                ...
                var result = userMgr.CreateAsync(angella, "123@123Aa").Result;
                if (!result.Succeeded)
                {
                ...
                result = userMgr.AddClaimsAsync(
                    ...
                    new Claim[]
                    {
                        new Claim(JwtClaimTypes.Name, "Doan Duc Tin"),
                        new Claim(JwtClaimTypes.GivenName, "Tin"),
                        new Claim(JwtClaimTypes.FamilyName, "Doan Duc"),
                        new Claim(JwtClaimTypes.WebSite, "https://www.satdevelop.com"),
                        new Claim("location", "Da Nang")
                    }).Result;
        ...
        private static void EnsureSeedData(ConfigurationDbContext context)
        {
            ...
            {
                foreach (var res in Config.ApiScopes.ToList())
                {
            ...
            {
                foreach (var res in Config.ApiResources.ToList())
                {
